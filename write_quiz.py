...
JSX = r"""import { useState, useEffect, useRef } from "react";
...
with open('d:/User/HCM/quiz/my-quiz/src/quiz.jsx', 'w', encoding='utf-8') as f:
    f.write(JSX)

print("quiz.jsx written successfully, size:", len(JSX), "bytes")
